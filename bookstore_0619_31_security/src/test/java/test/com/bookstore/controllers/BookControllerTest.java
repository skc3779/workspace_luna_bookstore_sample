...
public class BookControllerTest {
	...
	public void testList() throws Exception {
		this.mvc.perform(get("/books/list"))
	...
	@Test
	@Ignore	
	public void textAddHtml() throws Exception {
		
		this.mvc.perform(get("/books/add/html"))
		.andExpect(status().isOk())
		.andExpect(view().name(containsString("/add/html")));
		
		this.mvc.perform(post("/books/add/html"))
		.andExpect(status().isOk())
		.andExpect(model().hasErrors())
		.andExpect(model().attributeHasFieldErrors("bookForm", "name", "author"));
