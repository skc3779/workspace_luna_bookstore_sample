...
<html lang="ko">
  <head>
    ...
    <![endif]-->
		...
		<script type="text/javascript" src="<c:url value='/res/js/kendo.all.min.js' />"></script>
		<!-- 확장 JavaScript -->
		<script type="text/javascript" src="<c:url value='/contents/base/js/console.js' />"></script>
		<script type="text/javascript" src="<c:url value='/contents/base/js/jquery.serializeObject.js' />"></script>
