...
public class BookController {
	...
	final static String LOGIN_FAIL = "/login/fail";
	...
	public ModelAndView getList() throws Exception {
		...
		Log.info("controller books/list call");
		
		return mv;
	}	

	@RequestMapping(value=LOGIN_FAIL, method=RequestMethod.GET)
	public ModelAndView getLoginFail() throws Exception {
		ModelAndView mv = new ModelAndView();
		ArrayList<Map<String, Object>> books = bookService.listup();	
		mv.addObject("books", books);
		mv.addObject("login_fail_message", "로그인 실패!");
		mv.setViewName("/list");
		return mv;
	}
