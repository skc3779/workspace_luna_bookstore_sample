...
<h3>북스토어 책 저장하기(Spring Form 이용)</h3>

<div class="bs-docs-example">
  <form:form modelAttribute="book" name="book" method="post" cssClass="form-horizontal" action="${cp}/books/add/html">
      <fieldset>
         <legend>북스토어 책 저장하기(Spring Form 이용), <spring:message code="form.name.book"></spring:message></legend>
         <div class="control-group">
          <form:label path="name" cssClass="control-label" for="name">제목</form:label>
           <div class="controls">
            <form:input path="name" cssClass="input-xlarge" placeholder="제목을 넣어주세요"/>
         ...
         <div class="control-group">
          <form:label path="author" cssClass="control-label" for="author">저자</form:label>
           <div class="controls">
            <form:input path="author" cssClass="input-xlarge" placeholder="저자를 넣어주세요"/>
         ...
         <div class="control-group">
          <form:label path="publishDate" cssClass="control-label" for="publishDate">출판일</form:label>
           <div class="controls">
            <form:input path="publishDate" cssClass="input-xlarge" placeholder="출판일 예시) 2012-01-01"/>
         ...
         <div class="control-group">
          <form:label path="comment" cssClass="control-label" for="comment">설명</form:label>
           <div class="controls">
            <form:input path="comment" cssClass="input-xlarge" placeholder="설명을 넣어주세요"/>
           </div>
         </div>
      </fieldset>         
