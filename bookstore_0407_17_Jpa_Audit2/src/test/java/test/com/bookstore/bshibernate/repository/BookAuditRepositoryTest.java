...
@Transactional
public class BookAuditRepositoryTest {

	@Autowired BookAuditRepository bookAuditRepository;
	...
	public void testSave() {		
		...
		// 등록
		bookAuditRepository.save(book1);
		
		assertThat(bookAuditRepository.count() , not(Long.valueOf(0)));
		
		List<BookAudit> bookList = bookAuditRepository.findByName("Book01");
		listObject(bookList);
		...
		List<BookAudit> bookList2 = bookAuditRepository.findByName("Book01");
