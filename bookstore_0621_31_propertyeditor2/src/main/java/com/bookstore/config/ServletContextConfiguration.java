...
import com.bookstore.entities.properties.BookStoreWebBindingInitializer;
...
*/
	...
	@Bean
	/*
	 * AnnotationMethodHanlderAdapter 2.5 개발 되었으며, 3.2 에서 Deprecated 됨
	 * RequestMappingHandlerAdapter 
	 */
	public RequestMappingHandlerAdapter requestMappingHandlerAdapter() {
		RequestMappingHandlerAdapter handler = new RequestMappingHandlerAdapter();
		handler.setWebBindingInitializer(new BookStoreWebBindingInitializer());
		return handler;
	}
}
