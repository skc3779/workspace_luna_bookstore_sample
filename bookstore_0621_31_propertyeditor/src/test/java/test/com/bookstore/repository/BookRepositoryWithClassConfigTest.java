...
public class BookRepositoryWithClassConfigTest {
	...
	private static Log log = LogFactory.getLog(BookRepositoryWithClassConfigTest.class);
	...
	public List<Book> getBooks(){
		...
		book1.setPublishDate(new DateTime());
		...
		book2.setPublishDate(new DateTime());
		...
		book3.setPublishDate(new DateTime());
	...
	public void testUpdate() {
		...
		log.info("testUpdate " + bookRepository.findByName("Book01").get(0).getAuthor());
