...
public class Book2Controller {
	...
	@Inject
	Provider<UserPropertyEditor> userProertyEditor;
	
	@Inject
	Provider<BookStatusPropertyEditor> bookStatusPropertyEditor;
	
	@InitBinder
	public void initBinder(WebDataBinder dataBinder) {
		
		// Provider를 이용해 프로타입 빈의 새 오브젝트를 가져온다.
		dataBinder.registerCustomEditor(User.class, userProertyEditor.get());
		dataBinder.registerCustomEditor(BookStatus.class, bookStatusPropertyEditor.get());
