...
@ComponentScan(basePackages={"com.bookstore.services","com.bookstore.entities.properties", "com.bookstore.utils", "com.bookstore.validators"})
...
//@ImportResource(value={"classpath:/context-security.xml"})
