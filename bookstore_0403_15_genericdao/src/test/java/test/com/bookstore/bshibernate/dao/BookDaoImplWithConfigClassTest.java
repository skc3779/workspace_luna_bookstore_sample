...
import com.bookstore.bshibernate.config.HiberationConfiguration;
...
@ContextConfiguration(classes = HiberationConfiguration.class)
@RunWith(SpringJUnit4ClassRunner.class)
@Transactional
public class BookDaoImplWithConfigClassTest {
