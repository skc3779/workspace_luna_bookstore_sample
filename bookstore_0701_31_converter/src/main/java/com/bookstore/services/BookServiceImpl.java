...
public class BookServiceImpl implements BookService {
	...
	public Page<Book> findAll(int pageIndex, int pageSize) {
		//PageRequest request = new PageRequest(pageSize, pageSize, Direction.DESC, "publicDate");
		PageRequest request = new PageRequest(pageIndex, pageSize, Direction.DESC, "id");
